...
public class WikipediaAPI {
    ...
    //This method returns a string which includes a summary from Wikipedia about whatever the user input was inquiring about.
    //More specifically, if the user asks for a summary or more information about Ryan Reynolds movies, businesses, or himself,
    // this will use Wikipedia API to obtain more information and provide this back to the user
